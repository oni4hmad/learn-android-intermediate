...
//        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(dicodingSpace, 15f))
        ...
        /* manambahkan marker sesuai lokasi yang dipilih */
        mMap.setOnMapLongClickListener { latLng ->
            mMap.addMarker(
                MarkerOptions()
                    ...
                    .icon(vectorToBitmap(R.drawable.ic_baseline_location_on_24, Color.parseColor("#3DDC84")))
            )
        }
        ...
        /* mendapatkan lokasi kita: tambahkan permission di manifest trlbh dulu */
        getMyLocation()
        /* mengubah map style */
        setMapStyle()
    }
